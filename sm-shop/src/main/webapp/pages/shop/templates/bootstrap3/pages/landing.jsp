                ...
                <div class="carousel-inner">
                    <div class="item animated fadeInUp">
                        ...
                        <div class="caption">
                            ...
                            <div class="hidden-xs delay2 slider-desc animated fadeIn">Phasellus
...
scelerisque bibendum.</div>
                    ...
                    <div class="item  animated fadeInUp active">
                        <img alt="Third slide" src="<c:out value="/sm-shop/resources/templates/bootstrap3/img/slide_3.jpg"/>">
                        <div class="caption">
                            <div class=" slider-title animated fadeInDown delay1">GET YOUR DECORATION</div>
                            <div class="hidden-xs delay2 slider-desc animated fadeIn">Phasellus
 quis lectus metus, at posuere neque. Sed pharetra nibh eget orci 
...
scelerisque bibendum.</div>
                ...
                <a class="left carousel-control" href="#carousel-example-generic" data-slide="prev">
                    <img src="home-page-header_files/slide-left.png" alt="">
                </a>
                <a class="right carousel-control" href="#carousel-example-generic" data-slide="next">
                    <img src="home-page-header_files/slide-right.png" alt="">
                </a>
                -->
            </div>
        </div>
