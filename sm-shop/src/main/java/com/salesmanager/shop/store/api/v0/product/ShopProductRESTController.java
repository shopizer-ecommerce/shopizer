...
public class ShopProductRESTController extends BaseClass{
...
/*	*//**
	...
	public ReadableProduct getProduct(@PathVariable String store, @PathVariable final Long id, @RequestParam String lang, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		language = getLanguageByCode(merchantStore, lang);
	 ...
	 */
	private Language getLanguageByCode(MerchantStore merchantStore, String lang) throws ServiceException {
		Language language;
