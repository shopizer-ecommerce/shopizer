...
public class CustomerFacadeImpl implements CustomerFacade {
	...
	private static final String resetCustomerLink = "/customer/%s/reset/";
	...
	public void requestPasswordReset(String customerName, String customerContextPath, MerchantStore store, Language language) {
		...
		try {
			...
			//need to add /customer/{store}/resetPassowrdLink/{token}
			String customerResetLink = new StringBuilder()
			.append(baseUrl)
			.append(String.format(resetCustomerLink, store.getCode()))
			.append(token)
			.toString();
	...
	private void  resetPasswordRequest(Customer customer, String resetLink, MerchantStore store, Locale locale) throws Exception {
	    try {
	        ...
	        templateTokens.put(RESET_PASSWORD_LINK,
	        		resetLink);
	        ...
	        templateTokens.put(EmailConstants.EMAIL_CONTACT_OWNER,
	            messages.getMessage(EmailConstants.EMAIL_CONTACT_OWNER, storeEmail, locale));
	...
	@Override
	public void validatePasswordRequestToken(String token, String store) {
