 ...
 *
 * <!-- Simple add to cart html example ${id} is the product id --> <form id="input-${id}"> <input
 * type="text" class="input-small" id="quantity-productId-${id}" placeholder="1" value="1"> <a
 * href="#" class="addToCart" productId="${id}">Add to cart</a> </form>
 *
...
public class ShoppingCartController extends AbstractController {
  ...
  String removeShoppingCartItem(final Long lineItemId, final HttpServletRequest request,
    ...
    if (shoppingCartData != null && CollectionUtils
        .isEmpty(shoppingCartData.getShoppingCartItems())) {
