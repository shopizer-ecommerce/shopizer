	  ...
	  function languages() {
  			...
  			$.getJSON(url, function (data) {
		        ...
		        $.each(langs, function (i, langs) {             
		        	 $('<div class="checkbox"><label><input type="checkbox" name="supportedLanguages[]" id="supportedLanguages" data-parsley-mincheck="1" required value="' + langs.code + '">' + langs.name + '</label></div>').appendTo('#languages'); 
		        });
		        $.each(langs, function (i, langs) {             
