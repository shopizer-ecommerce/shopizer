...
public class ReferencesLoader {
	...
	public List<Language> loadLanguages(Locale locale) throws Exception {
        ...
        String resourceUrl
        = backend + "/languages?lang=" + locale.getLanguage();
	...
	public List<Country> loadCountry(Locale locale) throws Exception {
        ...
        String resourceUrl
        = backend + "/country?lang=" + locale.getLanguage();
	...
	public List<Zone> loadZones(String code, Locale locale) throws Exception {
        ...
        String resourceUrl
        = backend + "/zones?code=" + code + "&lang=" + locale.getLanguage();
        ...
        try {
	        ...
	        ResponseEntity<List<Zone>> resp =
	                restTemplate.exchange(resourceUrl,
	                            HttpMethod.GET, entity, new ParameterizedTypeReference<List<Zone>>() {
	                    });
	
	        
	        if(!HttpStatus.OK.equals(resp.getStatusCode())) {
	        	throw new AdminAuthenticationException("Cannot list zones [ " + resp.getStatusCode().name() + "]");
	        }
