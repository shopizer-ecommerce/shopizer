...
public class ShoppingCartServiceImpl extends
    SalesManagerEntityServiceImpl<Long, ShoppingCart> implements ShoppingCartService {
  ...
  public ShoppingCart getShoppingCart(final Customer customer) throws ServiceException {
    try {
      ...
      populatedShoppingCart(shoppingCart);
  ...
  public ShoppingCart getByCustomer(final Customer customer) throws ServiceException {
    ...
    try {
      ...
      return populatedShoppingCart(shoppingCart);
  ...
  private ShoppingCart populatedShoppingCart(final ShoppingCart shoppingCart) {
    try {
      ...
      LOGGER.error("Failed to update cart:", serviceException);
    }
  ...
  @Transactional
  private void getPopulatedItem(final ShoppingCartItem item) {
    ...
    ArrayList<ProductAttribute> attributesList = new ArrayList(); //attributes maintained
    ArrayList<ShoppingCartAttributeItem> removeAttributesList = new ArrayList(); //attributes to remove
    ...
    if ((productAttributes != null && productAttributes.size() > 0) &&
      ...
      for (ShoppingCartAttributeItem attribute : cartAttributes) {
        ...
        for (ProductAttribute productAttribute : productAttributes) {
          if (productAttribute.getId() == attributeId) {
