...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query("select u from User as u inner join fetch u.groups ug join fetch u.merchantStore um left join fetch u.defaultLanguage ul where u.id= ?1 and um.code = ?2 order by u.id")
