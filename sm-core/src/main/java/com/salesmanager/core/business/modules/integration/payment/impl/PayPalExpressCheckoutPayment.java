...
//			}
			...
			Long transactionUID = UUID.randomUUID().getMostSignificantBits()  & Long.MAX_VALUE;
...
//			 
			...
			Map<String,String> paymentMetaData = paypalPayment.getPaymentMetaData();
			 ...
			 transaction.getTransactionDetails().put("BANKTXNID",paymentMetaData.get("BANKTXNID"));
			 transaction.getTransactionDetails().put("ORDERID",paymentMetaData.get("ORDERID"));
			 transaction.getTransactionDetails().put("PAYMENTMODE",paymentMetaData.get("PAYMENTMODE"));
			 transaction.getTransactionDetails().put("RESPCODE",paymentMetaData.get("RESPCODE"));
			 transaction.getTransactionDetails().put("STATUS",paymentMetaData.get("STATUS"));
			 transaction.getTransactionDetails().put("TXNAMOUNT",paymentMetaData.get("TXNAMOUNT"));
			 transaction.getTransactionDetails().put("TXNDATE",paymentMetaData.get("TXNDATE"));
			 transaction.getTransactionDetails().put("TXNID",paymentMetaData.get("TXNID"));
