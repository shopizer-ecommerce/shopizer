...
public class S3StaticContentAssetsManagerImpl implements ContentAssetsManager {
	...
	public OutputContentFile getFile(String merchantStoreCode, FileContentType fileContentType, String contentName)
        ...
        try
        {
            ...
            S3Object o = s3.getObject(bucketName, nodePath(merchantStoreCode) + contentName);
	...
	public void addFile(String merchantStoreCode, InputContentFile inputStaticContentData) throws ServiceException {
        ...
        try
        {
        	...
        	String nodePath = nodePath(merchantStoreCode);
            ...
            s3.putObject(bucketName, nodePath+inputStaticContentData.getFileName(), inputStaticContentData.getFile(), metadata);
	...
	public void removeFile(String merchantStoreCode, FileContentType staticContentType, String fileName)
        ...
        try
        {
            ...
            final AmazonS3 s3 = s3Client();
            s3.deleteObject(bucketName, nodePath(merchantStoreCode) + fileName);
    ...
    private AmazonS3 s3Client() {
    	...
    	AmazonS3 s3 = 
    	        AmazonS3ClientBuilder.standard()
    	                             .withRegion(regionName()) // The first region to try your request against
    	                             .build();
    ...
    private String nodePath(String store) {
    	return new StringBuilder().append(ROOT_NAME).append(Constants.SLASH).append(store).append(Constants.SLASH).toString();
    }
